...
public interface OrderHistoryRepository  extends JpaRepository<OrderHistory, Long> {
    ...
    @Query(value ="select o from OrderHistory o where o.company = :company and o.plant = :plant and o.date = :date")
    List<OrderHistory> findOrderHistoryDetail(@Param("company") Company company, @Param("plant") Plant plant, @Param("date") String date);
